...
/**
 * AndroidContextDeployer TODO this class should be able to extend ContextDeployer rather than reimplement it entirely.
 * 
 */
public class AndroidContextDeployer extends AbstractLifeCycle
{
    ...
    /**
     * @param seconds
     *            The period in second between scans for changed configuration files. A zero or negative interval
